...
var CucumberReporter = function () {
    ...
    (0, _createClass3.default)(CucumberReporter, [{
        ...
        value: function getUniqueIdentifier(target) {
            if (target.type === 'Hook') {
                var _name = _get__('path').basename(target.location.uri);
                var _line = target.location.line;

                return _name + _line;
            }

            var name = target.name || target.text;
            var location = target.location || target.locations[0];
            var line = location && location.line || '';
...
var _typeOfOriginalExport = typeof CucumberReporter;
