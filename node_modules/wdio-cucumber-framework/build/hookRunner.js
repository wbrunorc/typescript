...
var HookRunner = function () {
    function HookRunner(eventBroadcaster, config) {
    ...
    (0, _createClass3.default)(HookRunner, [{
        ...
        value: function handleBeforeFeature(uri, feature) {
            return _get__('executeHooksWithArgs')(this.config.beforeFeature, feature);
        }
    }, {
        key: 'handleBeforeScenario',
        value: function handleBeforeScenario(uri, feature, scenario) {
            return _get__('executeHooksWithArgs')(this.config.beforeScenario, scenario);
        }
    }, {
        key: 'handleBeforeStep',
        value: function handleBeforeStep(uri, feature, scenario, step) {
            return _get__('executeHooksWithArgs')(this.config.beforeStep, step);
        }
    }, {
        key: 'handleAfterStep',
        value: function handleAfterStep(uri, feature, scenario, step, result) {
            return _get__('executeHooksWithArgs')(this.config.afterStep, step, result);
        }
    }, {
        key: 'handleAfterScenario',
        value: function handleAfterScenario(uri, feature, scenario) {
            return _get__('executeHooksWithArgs')(this.config.afterScenario, scenario);
        }
    }, {
        key: 'handleAfterFeature',
        value: function handleAfterFeature(uri, feature) {
            return _get__('executeHooksWithArgs')(this.config.afterFeature, feature);
        }
    }]);
    return HookRunner;
}();
...
var _typeOfOriginalExport = typeof HookRunner;
